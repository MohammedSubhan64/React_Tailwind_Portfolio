...
const Contact = () => {
  return (
    <div name='contact' className="w-full h-screen bg-[#0a192f] flex justify-center items-center px-4  ">
        ...
        <div className="pb-8">
            <p className='text-4xl font-bold my-4 inline border-b-4 border-pink-600 text-gray-300'>Contact</p>
        ...
        <button className=' py-3 px-4 my-4 mx-auto flex items-center text-white border-2 hover:bg-pink-600 hover:border-pink-600 '>let's Collaborate</button>
        </form>
