...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]  '>
        ...
        <p className="text-pink-600 hcolor ">Hi, my name is</p>
        ...
        <div className="">
            <button className=' group text-white border-2 px-6 py-3 my-2 flex items-center hover:border-pink-600 hover:bg-pink-600'>
